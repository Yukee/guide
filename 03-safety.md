...
The [basics page](02-dmt-basics.md) gave you the short version: DMT is generally low-risk, but drug interactions are the main concern. This page goes deeper. **If you take any medication, supplement, or herbal remedy, read this page before your first use.** Even if you take nothing, the sections on serotonin syndrome and who should avoid DMT are worth reading.

> **The bottom line up front:**
>
> - If you take **lithium**, stop here — **do not take DMT**. The combination can cause seizures.
> - If you take **any other medication**, check the table below before your first use.
> - If you take **nothing**, the risks are very low. Skim the rest of this page and move on to [preparation](05-what-youll-need.md).

---

## Check Your Medications

DMT acts on the brain's serotonin system — serotonin is a chemical your brain uses to regulate mood, sleep, and pain. Many common medications also target this system. When two drugs affect serotonin at the same time, their effects can combine in dangerous ways. Before you use DMT for the first time, **make a list of everything you take** — prescriptions, over-the-counter medications, supplements, herbal remedies — and check it against this table.
...
| **MAOIs** | Phenelzine (Nardil), tranylcypromine (Parnate), isocarboxazid (Marplan), moclobemide (Manerix); antibiotics: linezolid; plant-based: ayahuasca, Syrian rue, changa | **High — serotonin syndrome** | Must talk to your doctor. Must always have a [sitter](06-aborting-protocol.md#your-sitter-what-they-need-to-know) (a trusted person who stays with you to monitor your safety). Read the [serotonin syndrome section](#serotonin-syndrome-what-you-need-to-know) below. |
| **SSRIs / SNRIs** | Fluoxetine (Prozac), sertraline (Zoloft), paroxetine (Paxil), citalopram (Celexa), escitalopram (Lexapro), venlafaxine (Effexor), duloxetine (Cymbalta) | **Medium — serotonin effects can stack** | Talk to your doctor. |
...
This section explains each category from the table above. Read the parts that apply to you.
...
If you take lithium, do not attempt to taken DMT.

### MAOIs

MAOIs (monoamine oxidase inhibitors) are medications that slow down the body's ability to break down serotonin. This creates two distinct dangers when combined with DMT:
...
**Recommendation:** Wait at least **24 hours** after your last triptan dose before using DMT. **Exception: frovatriptan (Frova)** has a much longer half-life — wait at least **5 days**. Some patients eventually use DMT as a replacement for triptans, which avoids the interaction entirely.
...
![Drug interaction risk levels — visual summary showing lithium as a hard stop, MAOIs as high risk, SSRIs and SNRIs as moderate risk, triptans as low-to-moderate risk, and other serotonergic drugs as variable risk](images/illustration-drug-interaction-risk.jpg)
*Drug interaction risk levels at a glance. Red means do not combine. Orange means high risk — talk to your doctor. Yellow means moderate risk. Blue means low-to-moderate risk. Gray means variable risk.*
...
Serotonin syndrome happens when your brain is flooded with too much serotonin. It's most likely when DMT is combined with another drug that also raises serotonin — especially MAOIs, or multiple serotonergic drugs stacking together.

The risk of serotonin syndrome increases with higher doses and more serotonergic drugs — but it's hard to predict in advance exactly which combination or dose will trigger it. That's why we recommend talking to your doctor, starting with low doses, and having a sitter.
...
- [Demystifying Serotonin Syndrome](https://www.cfp.ca/content/64/10/720) (Canadian Family Physician) — includes a [patient info sheet](https://www.cfp.ca/content/cfp/suppl/2018/10/11/64.10.720.DC1/720_SS_Infographic_Patient.pdf) you can print
...
The puff-wait-and-repeat protocol makes accidentally taking a high dose unlikely. But if it does happen, remember: **the experience will be completely over in 10–20 minutes.**
...
*At aborting doses, the overall safety profile is favorable. Drug interactions are the main concern. Cardiovascular and psychological risks are minimal for most people.*
...
- You have a **psychotic disorder** (e.g., schizophrenia) or a close family history of one

**Talk to your doctor first if:**

- You take an MAOI
- You take an SSRI, SNRI, or other serotonergic medication
- You take triptans regularly
- You have high blood pressure or a heart condition
- You have a history of stroke or seizures
- You take multiple medications or supplements

**You are likely clear if:**

- You've checked the [medication table](#check-your-medications) above and none of your medications are listed
- You're in generally good health
- You plan to follow the [puff-wait-and-repeat protocol](06-aborting-protocol.md)
...
- [ ] **Interactions checked.** I have checked each one against the [drug interactions table](#check-your-medications) above.
- [ ] **Doctor consulted (if needed).** If any of my medications are listed in the table, I have talked to my doctor.
...
- **Medications checked, ready to prepare?** Go to [preparing your vape pen](05-what-youll-need.md).
